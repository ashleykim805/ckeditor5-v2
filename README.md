...
## instructions for the dumb binch
1. `rm -rf node_modules` in the ckeditor5 project
2. `npm install {packagename}`
3. `npm i`
4. `npm run build`
5. push changes
6. delete ALL `node_modules` folders in your actual project (both server + client)
7. npm install again in both folders
...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `jzy8b7rzv7y3-d25qdtknhosc`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
